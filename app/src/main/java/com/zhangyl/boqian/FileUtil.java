...
public class FileUtil {
    ...
    public static void openFiles(Context context, String filesPath) {
        Uri uri = FileProvider.getUriForFile(context.getApplicationContext(), "com.zhangyl.boqian", new File(filesPath));
    ...
    public static Intent showOpenTypeDialog(Context context, String param) {
        ...
        Uri uri = FileProvider.getUriForFile(context.getApplicationContext(), "com.zhangyl.boqian", new File(param));
